...
export const useMovieData = () => {
    ...
    const moviesFiltered = useSelector((state: RootState) => state.movies.filteredMovies);
    ...
    return { movies, movieDetails, moviesFiltered, hasMore, genres, popularMoviesByGenre, loading, error };
  };
